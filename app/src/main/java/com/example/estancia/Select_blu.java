 ...
 */
public class Select_blu extends Activity implements PullToRefresh.OnRefreshListener {
   ...
   // private Button not_found;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.select_blu);
            ...
            if (action.equals(BluetoothAdapter.ACTION_STATE_CHANGED)) {
                ...
                switch (state) {
                    case BluetoothAdapter.STATE_OFF:
                        ...
                        Toast.makeText(Select_blu.this, "Turn on bluetooth", Toast.LENGTH_LONG).show();
                        break;
